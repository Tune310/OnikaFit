...
function additional_custom_styles() {
	/*Enqueue The Styles*/
    wp_enqueue_style( 'uniquestylesheetid', get_template_directory_uri() . '/css/new.css' ); 
}
...
add_action('wp_ajax_validate_user_ajax_request','validate_user_ajax_request_func');
add_action('wp_ajax_nopriv_validate_user_ajax_request', 'validate_user_ajax_request_func');
function validate_user_ajax_request_func(){
	//echo 'h';
	...
	$users = $wpdb->get_results("SELECT * FROM $users WHERE user_login='$user_name'");
	if($wpdb->num_rows>0){
		echo "false";
	}else{
		echo "true";
...
add_action('wp_ajax_validate_email_ajax_request','validate_email_ajax_request_func');
add_action('wp_ajax_nopriv_validate_email_ajax_request', 'validate_email_ajax_request_func');
function validate_email_ajax_request_func(){
	//echo 'h';
	...
	$users = $wpdb->get_results("SELECT * FROM $users WHERE user_email='$email'");
	if($wpdb->num_rows>0){
		echo "false";
	}else{
		echo "true";
